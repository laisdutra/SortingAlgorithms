...
- Para n razoavelmente grande, o termo log(n) é quase constante, de modo que o tempo de ordanação é quase linear com o número de itens
- O heapsort não é estável, porém é possível adaptar a estrutura a ser ordenada de forma a tornar a ordenação estável
*/
